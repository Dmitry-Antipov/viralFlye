...
class reference_stats:
    ...
    def __str__(self):
        return(self.name +" " + str(self.reference_length) + " " + str(self.different_contigs))
...
#    print(af)
 ...
 #           print(line)
            ...
            res[arr[0]].reference_length = int(arr[2])
    ...
    for s in stats:
        ...
        if ref.genome_fraction < 0.80:
            ...
            if ref.largest_contig *0.8 > ref.reference_length:
                large80.add(s)
    print ("Format: reference_id ref_length different_contigs_in_quast_alignments")
...
def main():
    if len(sys.argv) != 2:
        print ("Usage: " + sys.argv[0] + "path to metaquast results for assembly and ref in this order")
